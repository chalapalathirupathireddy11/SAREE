package com.sarees.sarees.Security;

import com.sarees.sarees.Entity.Role;
...
@Component
@Profile("!prod")
public class SareeShopNonProdUsernamePwdAuthenticationProvider implements AuthenticationProvider {
